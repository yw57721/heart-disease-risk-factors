...
from bert_ner.metrics.classes import StandoffAnnotation, Evaluate, CombinedEvaluation, \
    PHITrackEvaluation, CardiacRiskTrackEvaluation
import argparse
import os
from collections import defaultdict
from bert_ner.metrics.tags import DocumentTag, PHITag, MEDICAL_TAG_CLASSES
    ...
    for d in system_dirs:
        for fn in os.listdir(d):
            ...
            if fn.endswith("xml"):
                ...
                sa = StandoffAnnotation(filepath)
                documents[sa.sys_id][sa.id] = sa
                # print("-------here")
                # print(documents[""]["320-02"])
                # print(sa.text)
